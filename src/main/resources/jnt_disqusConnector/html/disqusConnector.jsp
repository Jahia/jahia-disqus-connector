                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="disqusShortnameField" name="shortname" type="text"
                                           value="<c:if test="${!empty shortname}">${shortname.string}</c:if>"
                                           onblur="shortnameInput=$(this).val();"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="disqusApiKeyField" name="publicKey" type="text"
                                           value="<c:if test="${!empty publicKey}">${publicKey.string}</c:if>"
                                           onblur="publicKeyInput=$(this).val();"/>
                                </div>
                            </div>
                            <div>
                    ...
                    <fieldset>
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                            ...
                            <tr>
                                ...
                                <th><fmt:message key="jnt_disqusConnector.postNumber"/></th>
